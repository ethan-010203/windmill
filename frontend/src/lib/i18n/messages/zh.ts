...
export const zh: Record<MessageKey, string> = {
	...
	// Login
	'login.title': '登录或注册',
	'login.subtitle': '请选择下面任一方式登录或注册',
	'login.fill_email_password': '请填写邮箱和密码',
	'login.invalid_credentials': '账号或密码无效',
	'login.popup_blocked': '弹窗被拦截，请点击登录按钮继续。',
	'login.no_saml': '没有可用的 SAML 登录方式',
	'login.signing_in': '正在登录...',
	'login.password_login': '使用账号密码登录',
	'login.default_credentials': '欢迎！已自动填入默认账号 admin@windmill.dev / changeme。',
	'login.email': '邮箱',
	'login.password': '密码',
