export const en = {
	...
	'login.subtitle': 'Log in or sign up with any of the methods below',
	'login.fill_email_password': 'Please fill in both email and password',
	'login.invalid_credentials': 'Invalid credentials',
	'login.popup_blocked': 'Popup blocked — please click the sign-in button to continue.',
	'login.no_saml': 'No SAML login available',
	'login.signing_in': 'Signing you in…',
	'login.password_login': 'Log in without third-party',
	'login.default_credentials': 'Welcome! Default credentials admin@windmill.dev / changeme have been prefilled.',
	'login.email': 'Email',
